...
def filter_csv(csv, query):
    ...
    # Separates files by test subject
    path_dict = {}
...
def filter_images(input_path, query):
    ...
    if os.path.isdir(input_path):
        ...
        image_paths = get_image_path_list(input_path, False, 1)
