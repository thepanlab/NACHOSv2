...
def get_accuracies_and_stderr(true, pred):
    ...
    for config in pred:
        ...
        # Gets the accuracy and other metrics of every test-val fold pair
    ...
    # Calculates the standard error of the accuracies
    errs = {}
    for config in pred:
        errs[config] = {}
...
def total_output(accuracies, standard_error, output_path, output_file, is_outer):
    """
    ...
    for config in configs:
        ...
        # Adds a row of val-fold accuracies
        row = {}
...
def main(config = None):
    ...
    # Gets accuracies and standard error
    accuracies, stderr = get_accuracies_and_stderr(true, pred)

    # Graphes results
    total_output(accuracies, stderr, config['output_path'], config['output_filename'], is_outer = config['is_outer'])
