from scripts.training.training_sequential import sequential_processing
import datetime
import time
import os
...
if __name__ == "__main__":
    ...
    with open(os.path.join("../results/training_timings", f'_TIME_SEQ_OUTER_{start_time_name}.txt'), 'w') as fp:
